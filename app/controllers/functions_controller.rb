class FunctionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @function.save
        format.html { redirect_to function_url(@function), notice: "Function was successfully created." }
  ...
  def update
    respond_to do |format|
      if @function.update(function_params)
        format.html { redirect_to function_url(@function), notice: "Function was successfully updated." }
  ...
  private
    ...
    def function_params
      params.require(:function).permit(:name, :description, :slug)
    end
end
